...
dom.class.add(test, 'add'); // dom.class.remove(test, 'add');
...
var testDiv = dom.find('#test')[0]; // 你要获取的是div，而不是数组

console.log(testDiv);
var test2 = dom.find('#test2')[0];
console.log(dom.find('.red', test2)[0]);
console.log(dom.parent(test2));
var s2 = dom.find('#i2')[0];
...
var div2 = dom.find('#test2>.red')[0];
console.log(dom.style(div2, 'color', 'red')); // 获取多个 div.red 元素

var divList = dom.find('.red'); // 遍历 divList 里的所有元素
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10739" + '/');
